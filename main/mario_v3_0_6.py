# v3_0_6 — 三分类版（左手/右手/空白对照）：
#   基于 v3_0_5 架构
#   加入空白对照组（不动/不放空），三种任务各 50 试次
#   6 Block × 25 trial = 150 试次
#   90s 静息提前到每个 Block 之前
import pygame
...
def run_rest_block(surface, virtual_screen, duration_ms=90000, hint_text="【闭眼静息中】", extend_key=False, _extended_out=None):
    start = pygame.time.get_ticks()
    extended = False
    extend_start = 0
    total_extended_ms = 0
